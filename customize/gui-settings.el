...
(cond ((eq window-system 'ns)
       ...
       (set-fontset-font (frame-parameter nil 'font)
			 'han (font-spec :family "STHeiTi" :size 18))
       (set-fontset-font (frame-parameter nil 'font)
			 'symbol (font-spec :family "STHeiTi" :size 18))
       (set-fontset-font (frame-parameter nil 'font)
			 'cjk-misc (font-spec :family "STHeiTi" :size 18))
       (set-fontset-font (frame-parameter nil 'font)
			 'bopomofo (font-spec :family "STHeiTi" :size 18)))
